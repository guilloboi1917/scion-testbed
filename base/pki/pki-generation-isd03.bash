...
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "18-ffaa:1:1", "common_name": "18-ffaa:1:1 AS cert"}') AS11/cp-as.pem AS11/cp-as.key --ca AS11/cp-ca.pem --ca-key AS11/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "18-ffaa:1:2", "common_name": "18-ffaa:1:2 AS cert"}') AS12/cp-as.pem AS12/cp-as.key --ca AS12/cp-ca.pem --ca-key AS12/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "18-ffaa:1:3", "common_name": "18-ffaa:1:3 AS cert"}') AS13/cp-as.pem AS13/cp-as.key --ca AS11/cp-ca.pem --ca-key AS11/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "18-ffaa:1:4", "common_name": "18-ffaa:1:4 AS cert"}') AS14/cp-as.pem AS14/cp-as.key --ca AS11/cp-ca.pem --ca-key AS11/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "18-ffaa:1:5", "common_name": "18-ffaa:1:5 AS cert"}') AS15/cp-as.pem AS15/cp-as.key --ca AS12/cp-ca.pem --ca-key AS12/cp-ca.key --bundle
