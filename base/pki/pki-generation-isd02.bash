...
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "17-ffaa:1:1", "common_name": "17-ffaa:1:1 AS cert"}') AS6/cp-as.pem AS6/cp-as.key --ca AS6/cp-ca.pem --ca-key AS6/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "17-ffaa:1:2", "common_name": "17-ffaa:1:2 AS cert"}') AS7/cp-as.pem AS7/cp-as.key --ca AS7/cp-ca.pem --ca-key AS7/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "17-ffaa:1:3", "common_name": "17-ffaa:1:3 AS cert"}') AS8/cp-as.pem AS8/cp-as.key --ca AS6/cp-ca.pem --ca-key AS6/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "17-ffaa:1:4", "common_name": "17-ffaa:1:4 AS cert"}') AS9/cp-as.pem AS9/cp-as.key --ca AS6/cp-ca.pem --ca-key AS6/cp-ca.key --bundle
scion-pki certificate create --profile=cp-as <(echo '{"isd_as": "17-ffaa:1:5", "common_name": "17-ffaa:1:5 AS cert"}') AS10/cp-as.pem AS10/cp-as.key --ca AS7/cp-ca.pem --ca-key AS7/cp-ca.key --bundle
